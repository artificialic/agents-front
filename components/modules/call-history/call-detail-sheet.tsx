    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="w-full overflow-y-auto sm:max-w-lg">
        ...
        <div className="border-b border-gray-300 p-4">
          ...
          <div className="flex inline-flex items-start justify-start gap-2">
            <div className="mt-2 inline-flex w-[280px] flex-col items-start justify-start gap-2">
              <div className="flex inline-flex items-center justify-start gap-2">
                <div className="relative h-5 w-5 text-gray-500">
                ...
                <div className="text-sm font-normal leading-tight text-gray-950">Llamada Exitosa</div>
              </div>
              <div className="flex inline-flex items-center justify-start gap-2">
                <div className="relative h-5 w-5 text-gray-500">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                <div className="text-sm font-normal leading-tight text-gray-950">Estado de la Llamada</div>
              </div>
              <div className="flex inline-flex items-center justify-start gap-2">
                <div className="relative h-5 w-5 text-gray-500">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                <div className="text-sm font-normal leading-tight text-gray-950">Sentimiento del Usuario</div>
              </div>
              <div className="flex inline-flex items-center justify-start gap-2">
                <div className="relative h-5 w-5 text-gray-500">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                <div className="text-sm font-normal leading-tight text-gray-950">Razón de Desconexión</div>
              </div>
            </div>
              ...
              <div className="flex inline-flex items-center justify-start gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="6" height="6" viewBox="0 0 8 8" fill="none">
                  <g clipPath="url(#clip0)">
                    ...
                    <path
                      ...
                      fill={call.call_analysis?.call_successful ? '#10b981' : '#ef4444'}
                    />
                  </g>
                  <defs>
                    <clipPath id="clip0">
                ...
                <div
                  className={`text-sm font-normal leading-tight ${
                    call.call_analysis?.call_successful ? 'text-green-600' : 'text-red-600'
                  }`}
                >
                  {call.call_analysis?.call_successful ? 'Exitosa' : 'Fallida'}
                </div>
              </div>
              <div className="flex inline-flex items-center justify-start gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="6" height="6" viewBox="0 0 8 8" fill="none">
                  <g clipPath="url(#clip1)">
                    ...
                    <path
                      d="M1.3999 4.00039C1.3999 2.56445 2.56396 1.40039 3.9999 1.40039C5.43584 1.40039 6.5999 2.56445 6.5999 4.00039C6.5999 5.43633 5.43584 6.60039 3.9999 6.60039C2.56396 6.60039 1.3999 5.43633 1.3999 4.00039Z"
                      fill={
                        call.call_status === 'completed' || call.call_status === 'registered' ? '#10b981' : '#ef4444'
                      }
                    />
                  </g>
                  <defs>
                ...
                <div
                  className={`text-sm font-normal leading-tight ${
                    call.call_status === 'completed' || call.call_status === 'registered'
                      ? 'text-green-600'
                      : 'text-red-600'
                  }`}
                >
              ...
              <div className="flex inline-flex items-center justify-start gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="6" height="6" viewBox="0 0 8 8" fill="none">
                  <g clipPath="url(#clip2)">
                    ...
                    <path
                      d="M1.3999 4.00039C1.3999 2.56445 2.56396 1.40039 3.9999 1.40039C5.43584 1.40039 6.5999 2.56445 6.5999 4.00039C6.5999 5.43633 5.43584 6.60039 3.9999 6.60039C2.56396 6.60039 1.3999 5.43633 1.3999 4.00039Z"
                      fill={call.call_analysis?.user_sentiment === 'Positive' ? '#10b981' : '#ef4444'}
                    />
                  </g>
                  <defs>
                    <clipPath id="clip2">
                ...
                <div
                  className={`text-sm font-normal leading-tight ${
                    call.call_analysis?.user_sentiment === 'Positive' ? 'text-green-600' : 'text-red-600'
                  }`}
                >
                  {call.call_analysis?.user_sentiment === 'Positive' ? 'Positivo' : 'Negativo'}
                </div>
              </div>
              <div className="flex inline-flex items-center justify-start gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="6" height="6" viewBox="0 0 8 8" fill="none">
                ...
                <div className="text-sm font-normal leading-tight text-red-600">
                  {call.disconnection_reason || 'agente_colgó'}
                </div>
                <a
                  href="https://docs.retellai.com/reliability/debug-call-disconnect#understanding-disconnection-reasons"
                  target="_blank"
