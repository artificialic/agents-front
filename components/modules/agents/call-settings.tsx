...
export function CallSettings({ agent, onAgentUpdate }: CallSettingsProps) {
  ...
  return (
    <div className="space-y-6 py-2 pl-7 pr-3">
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-xs text-muted-foreground">Colgar o dejar un mensaje si se detecta un buzón de voz.</p>
          </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    La IA responderá cuando el usuario presione la tecla de terminación configurada (0-9, #, *).
                  </p>
                </div>
                <Switch checked={dtmfTerminationKeyEnabled} onCheckedChange={handleDtmfTerminationKeyEnabledChange} />
              </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    La IA responderá inmediatamente después de que el llamante ingrese el número configurado de dígitos.
                  </p>
                </div>
                <Switch checked={dtmfDigitLimitEnabled} onCheckedChange={handleDtmfDigitLimitEnabledChange} />
              </div>
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-muted-foreground">
          La duración máxima de timbre antes de que la llamada saliente / transferencia se considere sin respuesta.
        </p>
        <Slider
          value={ringDuration}
